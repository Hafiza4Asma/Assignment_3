...
const Contact = () => {
  return (
    <div id="Contact">
     <section className="text-gray-600 body-font relative bg-skyblue-5000">
  <div className="container px-5 py-24 mx-auto">
     <div className="flex flex-col text-center w-full mb-12">
      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full bg-blue-100 bg-opacity-50 
              rounded border border-blue-500 focus:border-blue-500 
        ...
        <div className="p-2 w-full">
          <div className="relative">
            ...
            <textarea
              ...
              className="w-full bg-blue-100 bg-opacity-50 
              rounded border border-blue-500 focus:border-blue-500 
              focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 
              text-base outline-none text-gray-700 py-1 px-3 
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-blue-500 border-0 
          py-2 px-8 focus:outline-none hover:bg-blue-300 rounded text-lg">
            Button
          </button>
        </div>
