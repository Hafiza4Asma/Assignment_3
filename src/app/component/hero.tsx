...
const Hero = () => {
  ...
  items-center">
    ...
    md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="w-[80px] h-[3px] bg-blue-300"></div>
      ...
      <div className="flex justify-center">
        <Link href={'#Contact'}>
        <button className="inline-flex text-white bg-blue-600 border-0 
        py-2 px-6 focus:outline-none hover:bg-blue-200 rounded text-lg">
            Contact
            </button>
        </Link>
      </div>
